 ...
 */
uint32_t TESTRIG_API vscl_ident_names(void);
 ...
 */
uint32_t TESTRIG_API vscl_ident_protocols(char* device_name);
 ...
 */
uint32_t TESTRIG_API vscl_ident_interfaces(char* device_name, char* protocol_stack);
 ...
 */
uint32_t TESTRIG_API vscl_ident_ports(char* device_name, char* protocol_stack, char* device_interface);

/*
 *	@brief Print out controller characteristics.
 */
void TESTRIG_API vscl_print_characteristics(struct controller* controller_out);
